  ...
  return (
    <div id="container">
      ...
      <div id="box">
        ...
        {/*keyboard*/}
        <div id="keyboard">
          <button id="one" onClick={() => handleKey("1")} value="1">
            1
          </button>
          <button id="two" onClick={() => handleKey("2")} value="2">
            2
          </button>
          <button id="three" onClick={() => handleKey("3")} value="3">
            3
          </button>
          <button id="four" onClick={() => handleKey("4")} value="4">
            4
          </button>
          <button id="five" onClick={() => handleKey("5")} value="5">
            5
          </button>
          <button id="six" onClick={() => handleKey("6")} value="6">
            6
          </button>
          <button id="seven" onClick={() => handleKey("7")} value="7">
            7
          </button>
          <button id="eight" onClick={() => handleKey("8")} value="8">
            8
          </button>
          <button id="nine" onClick={() => handleKey("9")} value="9">
            9
          </button>
          <button id="zero" onClick={() => handleKey("0")} value="0">
            0
          </button>
          <button id="add" onClick={() => handleKey("+")} value="+">
            +
          </button>
          <button id="subtract" onClick={() => handleKey("-")} value="‑">
            -
          </button>
          <button id="multiply" onClick={() => handleKey("*")} value="x">
            *
          </button>
          <button id="divide" onClick={() => handleKey("/")} value="/">
            /
          </button>
          <button id="decimal" onClick={() => handleKey(".")} value=".">
            .
          </button>
          <button id="equals" onClick={() => handleEqual("equal")} value="=">
            =
          </button>
          <button id="clear" onClick={() => handleKey("clear")} value="AC">
            AC
          </button>
        </div>
      </div>
